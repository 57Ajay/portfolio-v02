          ...
          >
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="border-l-2 border-primary/50 pl-4 py-4">
                  <h3 className="text-xl font-semibold">Distributed Real-Time Communication Platform</h3>
                  <ul className="space-y-2 list-disc list-inside text-sm md:text-base mt-2">
                    <li>Full-stack WebRTC & WebSocket-based communication system</li>
                    <li>Technologies: Node.js, React, Kubernetes, WebRTC</li>
                    <li>Implemented peer-to-peer video conferencing with secure communication</li>
                  </ul>
                </div>
